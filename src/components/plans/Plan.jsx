      ...
      <div className="container-fluid plan pt-5 pb-5">
        ...
        <div className="row">
          <div className="col">
            ...
            <div className=" tabs  ">
            <div className="rows d-lg-flex justify-content-around">
              <div className="col-5 me-lg-5">
                  <div className="one mt-4">
                    ...
                    <div className="para-4">
                      <p>Lorem ipsum dolor sit amet consectetur. Commodo ut ut in nisi.</p>
                    </div> 
                    ...
                    <button className='btn-4' style={{color:"white"}}> Buy Standard   </button>
                  </div>
              </div>
              <div className="col-5  ms-lg-5">
              <div className="one mt-4">
                    <div className="heading-3">
                        <h2>Explore</h2>    
                    </div>
